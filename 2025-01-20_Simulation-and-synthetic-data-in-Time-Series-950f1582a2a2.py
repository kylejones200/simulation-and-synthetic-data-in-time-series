...
def plot_white_noise() -> None:
    ...
    ar_process.generate_sample(nsample=500)
...
def plot_ar_1_process() -> None:
    ...
    ma_process.generate_sample(nsample=500)
...
def plot_ma_1_process() -> None:
    ...
    np.cumsum(arima_process.generate_sample(nsample=500))
...
def plot_arima_1_1_1_process() -> None:
    ...
    plt.show()
    time = np.arange(500)
    0.05 * time + np.random.normal(loc=0, scale=1, size=500)
